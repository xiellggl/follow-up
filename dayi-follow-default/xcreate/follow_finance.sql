...
INSERT INTO `dayi_follow_all`.`module`(`id`, `parentid`, `name`, `url`, `status`, `del_status`, `sort`, `description`, `create_by`, `update_by`, `create_time`, `update_time`, `css_name`) VALUES ('23b1278e000001a1', '', '首页数据权限', '', 1, 0, 1, '', 'admin', 'admin', '2018-12-22 16:46:20', '2018-12-28 15:16:01', '');
