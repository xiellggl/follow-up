...
#修补超管和管理员的部门id
update dayi_follow.follow_up set dept_id = 1 WHERE user_name='admin' or user_name='chenyh1';
...
#插入权限数据
INSERT INTO `dayi_follow`.`permission`(`id`, `name`, `url`, `moduleid`, `display_name`, `display_status`, `del_status`, `status`, `sort`, `description`, `create_by`, `update_by`, `create_time`, `update_time`, `parentid`) VALUES ('23b10044000001a1', '首页', '/index', '', NULL, 1, 0, 1, 0, '', 'admin', 'admin', '2018-12-22 13:58:42', '2018-12-22 14:33:28', '');
...
INSERT INTO `dayi_follow`.`permission`(`id`, `name`, `url`, `moduleid`, `display_name`, `display_status`, `del_status`, `status`, `sort`, `description`, `create_by`, `update_by`, `create_time`, `update_time`, `parentid`) VALUES ('23b11eab000001a1', '代理商', '/agent/assign/list', '23b11bec000001a1', NULL, 1, 0, 1, 0, '', 'admin', 'admin', '2018-12-22 16:08:25', '2018-12-24 16:20:34', '');
INSERT INTO `dayi_follow`.`permission`(`id`, `name`, `url`, `moduleid`, `display_name`, `display_status`, `del_status`, `status`, `sort`, `description`, `create_by`, `update_by`, `create_time`, `update_time`, `parentid`) VALUES ('23b11eab000002a1', '创客', '/org/assign/list', '23b11bec000001a1', NULL, 1, 0, 1, 3, '', 'admin', 'admin', '2018-12-22 16:08:58', '2018-12-24 16:20:29', '');
