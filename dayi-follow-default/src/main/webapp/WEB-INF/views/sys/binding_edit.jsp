                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-12 col-sm-6">
                                <input type="text" name="function_name" value="" class="form-control" required/>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-12 col-sm-6">
                                <input type="text" name="function_sort" value="" class="form-control" required/>
                            </div>
                            <div class="help-block col-xs-12 col-sm-reset inline tips_box"></div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-12 col-sm-6">
                                <input type="text" name="function_path" value="" class="form-control"/>
                            </div>
                            <div class="help-block col-xs-12 col-sm-reset inline tips_box"></div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-12 col-sm-6">
                                <textarea name="remark" class="form-control" style="height:60px;"></textarea>
                            </div>
                        </div>
                    </div>
                </div>
