...
bankselector.list=[
    ...
    {id:"58",name:"北京银行",site:"http://www.bankofbeijing.com.cn/ebank/onlinebank/"},
    {id:"59",name:"顺德农村商业银行",site:"http://www.sdebank.com/cms/S101_21/ebank/perbank/pc/index.html"}
];
...
bankselector.box=function(callback){
    ...
    var boxHtml='<form class="bank_select">'
        +'<table class="form_table box_noborder">'
        +'<tr>'
        +'<th width="100">选择银行</th>'
        +'<td>'
        +'<select name="bankId" class="inptStyle">'
        +'<option value="">选择银行</option>'
        +'</select>'
       // +'<p class="gray fz12">东莞银行、北京银行等城市银行请选择“城市银行”</p>'
        +'</td>'
        +'</tr>'
        +'<tr>'
        +'<th>选择城市</th>'
        ...
        +'</tr>'
        +'<tr>'
        +'<th style="vertical-align: top;">选择支行</th>'
        +'<td>'
    ...
    layer.open({
        ...
        success:function ($box,index) {
            ...
            $prov.on("change",function () {
                ...
                if(!checkSelected($bankSelect,"请先选择银行",$(this))){
                    return;
                }
            ...
            $btnSearch.on("click",function () {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        for(var i=0;i<len;i++){
                            html +='<li><label><input type="radio" name="branch" value="'+list[i].number+'" data-name="'+list[i].name+'" data-bankid="'+bankId+'" data-bank="'+bank+'"  data-prov="'+prov+'" data-city="'+city+'"/> '+list[i].name+'</label></li>';
                        }
                        html +='</ul>';
