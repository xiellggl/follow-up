 ...
 * 移动端城市地区选择控件
 */
window.MArea = (function() {
    //引入css
    document.head.appendChild(function(){
        var link = document.createElement('link');
        link.href = '/static/public/js/area/mArea.css';
        link.rel = 'styleSheet';
        link.id = 'MAreaCss';
        return link;
    }());
    ...
    MobileArea.prototype = {
        init: function(params) {
            ...
            if(params.addressIds){
                this.addressIds=params.addressIds;
            }
        ...
        finish: function(e) {
            ...
            if(this.addressIds){
                document.getElementById(this.addressIds[0]).value=provinceCode;
                if(cityCode){
                    document.getElementById(this.addressIds[1]).value=cityCode;
                }
                if(countyCode){
                    document.getElementById(this.addressIds[2]).value=countyCode;
                }
            }
            _self.close(e);
        },
