;(function(){
    'use strict';
    if (window.errorJsReport){
        return window.errorJsReport;
    };
     ...
     * 核心代码区
     **/
    var errorJsReport=function(params){
    ...
    window.errorJsReport=errorJsReport;
})();

/*===========================
 errorJsReport AMD Export
 ===========================*/
if (typeof(module) !== 'undefined'){
    module.exports = window.errorJsReport;
}
